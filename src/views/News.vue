...
import { getRecomNewsApi, searchNewsList } from '@/apis/news'
...
async function getNewsItems () {
  ...
  newsItems.value = [
    {
      news_id: 1,
      cover_img: require('../assets/img/new1.png'),
      news_title: '新机，芬兰科尼正面吊，堆高机，叉车代理',
      news_path: ''
      // path: '../assets/img/home1.png',
      // ews_desc: '这是描述',
      // news_content: '这是内容',
      // news_path: 'detail/1111',
      // state: true,
      // publish_time: '2023-03-14 10:00:00'n
    },
    {
      news_id: 2,
      cover_img: require('../assets/img/new2.png'),
      news_title: '旧正面吊、堆高机、和叉车等机械的翻新',
      news_path: ''
    },
    {
      news_id: 3,
      cover_img: require('../assets/img/new4.png'),
      news_title: '二手正面吊买卖',
      news_path: ''
    },
    {
      news_id: 4,
      cover_img: require('../assets/img/new6.png'),
      news_title: '二手堆高机买卖',
      news_path: ''
    }
  ]
